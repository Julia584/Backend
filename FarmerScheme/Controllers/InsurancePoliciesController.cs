...
namespace FarmerScheme.Controllers
{
    ...
    public class InsurancePoliciesController : ControllerBase
    {
        ...
        public InsurancePoliciesController(ProjectGladiatorContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != insurancePolicy.InsuranceNo)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<InsurancePolicy>> PostInsurancePolicy(InsurancePolicy insurancePolicy)
        {
            ...
            return CreatedAtAction("GetInsurancePolicy", new { id = insurancePolicy.InsuranceNo }, insurancePolicy);
        }
        ...
        {
            return _context.InsurancePolicies.Any(e => e.InsuranceNo == id);
        }
    }
}

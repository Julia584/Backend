...
namespace FarmerScheme.Controllers
{
    ...
    public class BanksController : ControllerBase
    {
        ...
        public BanksController(ProjectGladiatorContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Bank>> PostBank(Bank bank)
        {
            ...
            return CreatedAtAction("GetBank", new { id = bank.AccNo }, bank);
        }
        ...
        {
            return _context.Banks.Any(e => e.AccNo == id);
        }
    }
}
